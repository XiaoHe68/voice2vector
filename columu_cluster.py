...
def merge_from_onefile(featpath, foldername, savewhenk, disfunc,onefile_prefix,kpath=False,endfluster=1):
    ...
    merge_from_matrx(feat, foldername, savewhenk, disfunc,onefile_prefix,kpath=False,endfluster=1)

def merge_from_matrx(feat, foldername, savewhenk, disfunc,onefile_prefix,kpath=False,endfluster=1):
    if kpath:
